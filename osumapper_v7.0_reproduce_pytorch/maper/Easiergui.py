...
with gr.Blocks(title="WebUI") as app:
    ...
    with gr.Tabs():
        with gr.TabItem("osu std"):
            ...
            butstep1.click(step1, [models, map_file, audio_file], [output1], api_name="convert")
            with gr.Row():
            ...
            butstep2.click(step2, [], [output2], api_name="gan")
            with gr.Row():
                with gr.Column():
        ...
        with gr.TabItem("mania"):
            ...
            with gr.Row():
                output1 = gr.Textbox(label="Output information")
            mania_butstep1.click(mania_step1, [models, map_file, audio_file], [output1], api_name="mania_convert")# , note_density, hold_favor, divisor_favor, hold_max_ticks, hold_min_return, rotate_mode
            with gr.Row():
                with gr.Column():
